...
Analysed 50 financial news headlines using NLP and mapped sentiment 
scores against Nifty 50 daily price movements to identify correlations.
...
Cleaned and scored each headline as Positive / Negative / Neutral using TextBlob (NLP)
Pulled Nifty 50 historical data using yfinance
Merged sentiment scores with daily stock price % change
Built a dual-axis visualisation showing sentiment vs market movement

# Key Findings
Negative sentiment days showed correlation with Nifty downward movement
